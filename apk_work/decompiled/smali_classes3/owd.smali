...
.method public constructor <init>(Ld76;)V
    ...
    iput-object p1, p0, Lowd;->E:Ld76;

    new-instance p1, Lxec;

    invoke-direct {p1}, Lxec;-><init>()V

    iput-object p1, p0, Lowd;->H:Lxec;
...
.method public final E(Lc75;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Lmwd;-><init>(Lowd;Lc75;)V

    :goto_0
    iget-object p1, v0, Lmwd;->E:Ljava/lang/Object;
    ...
    iget-boolean p1, p0, Lowd;->F:Z

    if-nez p1, :cond_3

    iget-boolean p1, p0, Lowd;->G:Z

    if-nez p1, :cond_3

    iput v2, v0, Lmwd;->G:I

    iget-object p1, p0, Lowd;->H:Lxec;
