...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lmol;->a:Landroid/content/Context;

    return-void
.end method

.method public static a(Landroid/content/Context;)Lmol;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lmol;->b:Lmol;

    if-nez v1, :cond_0

    new-instance v1, Lmol;

    invoke-direct {v1, p0}, Lmol;-><init>(Landroid/content/Context;)V

    sput-object v1, Lmol;->b:Lmol;
...
.method public static final c(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_0
    sget-object v0, Lmol;->c:[B

    if-eqz p1, :cond_1

    sget-object p1, Lmol;->d:[B

    filled-new-array {v0, p1}, [[B

    move-result-object p1

    invoke-static {p0, p1}, Lmol;->d(Landroid/content/pm/PackageInfo;[[B)Z
...
.method public final b()Z
    ...
    iget-object p0, p0, Lmol;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v2}, Lmol;->c(Landroid/content/pm/PackageInfo;Z)Z
    ...
    :cond_1
    invoke-static {v0, v1}, Lmol;->c(Landroid/content/pm/PackageInfo;Z)Z
