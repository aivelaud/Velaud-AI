...
.method public static i(Lcom/anthropic/velaud/api/common/RateLimit;)Z
    ...
    instance-of v0, p0, Lcom/anthropic/velaud/api/common/RateLimit$WithinLimit;
    ...
    :cond_0
    instance-of v0, p0, Lcom/anthropic/velaud/api/common/RateLimit$Limited;
    ...
    invoke-interface {v0}, Lcom/anthropic/velaud/api/common/RateLimit$Limited;->getResolved()Lcom/anthropic/velaud/api/common/ResolvedLimit;

    move-result-object v2

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lcom/anthropic/velaud/api/common/ResolvedLimit;->getStatus()Lcom/anthropic/velaud/api/common/LimitStatus;
    ...
    instance-of v2, v0, Lcom/anthropic/velaud/api/common/RateLimit$ExceedsLimit;
    ...
    :cond_2
    instance-of v0, v0, Lcom/anthropic/velaud/api/common/RateLimit$ApproachingLimit;

    if-eqz v0, :cond_5

    check-cast p0, Lcom/anthropic/velaud/api/common/RateLimit$ApproachingLimit;

    invoke-virtual {p0}, Lcom/anthropic/velaud/api/common/RateLimit$ApproachingLimit;->getRemaining()Ljava/lang/Integer;
...
.method public final b(Ljava/lang/String;)Lcom/anthropic/velaud/api/common/RateLimit;
    ...
    invoke-virtual {v1, p1}, Ls7h;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    invoke-static {p1}, Lcom/anthropic/velaud/api/common/k;->a(Lcom/anthropic/velaud/api/common/RateLimit$Limited;)Ljava/util/Date;
