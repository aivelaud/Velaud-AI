...
.method public constructor <init>(Ljava/time/Instant;Ljava/time/ZoneOffset;Ljava/time/Instant;Ljava/time/ZoneOffset;Lnx6;Le1c;)V
    ...
    iput-object p1, p0, Ltqi;->a:Ljava/time/Instant;

    iput-object p2, p0, Ltqi;->b:Ljava/time/ZoneOffset;

    iput-object p3, p0, Ltqi;->c:Ljava/time/Instant;

    iput-object p4, p0, Ltqi;->d:Ljava/time/ZoneOffset;

    iput-object p5, p0, Ltqi;->e:Lnx6;

    iput-object p6, p0, Ltqi;->f:Le1c;
...
.method public final b()Ljava/time/Instant;
    ...
    iget-object p0, p0, Ltqi;->a:Ljava/time/Instant;
...
.method public final e()Ljava/time/Instant;
    ...
    iget-object p0, p0, Ltqi;->c:Ljava/time/Instant;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p1, Ltqi;->e:Lnx6;

    iget-object v1, p0, Ltqi;->e:Lnx6;
    ...
    :cond_2
    iget-object v0, p0, Ltqi;->a:Ljava/time/Instant;

    iget-object v1, p1, Ltqi;->a:Ljava/time/Instant;
    ...
    :cond_3
    iget-object v0, p0, Ltqi;->b:Ljava/time/ZoneOffset;

    iget-object v1, p1, Ltqi;->b:Ljava/time/ZoneOffset;
    ...
    :cond_4
    iget-object v0, p0, Ltqi;->c:Ljava/time/Instant;

    iget-object v1, p1, Ltqi;->c:Ljava/time/Instant;
    ...
    :cond_5
    iget-object v0, p0, Ltqi;->d:Ljava/time/ZoneOffset;

    iget-object v1, p1, Ltqi;->d:Ljava/time/ZoneOffset;
    ...
    :cond_6
    iget-object p0, p0, Ltqi;->f:Le1c;

    iget-object p1, p1, Ltqi;->f:Le1c;
...
.method public final g()Ljava/time/ZoneOffset;
    ...
    iget-object p0, p0, Ltqi;->b:Ljava/time/ZoneOffset;
...
.method public final hashCode()I
    ...
    iget-object v2, p0, Ltqi;->a:Ljava/time/Instant;
    ...
    iget-object v3, p0, Ltqi;->b:Ljava/time/ZoneOffset;
    ...
    iget-object v3, p0, Ltqi;->c:Ljava/time/Instant;

    invoke-static {v3, v0, v1}, Ls0i;->i(Ljava/time/Instant;II)I

    move-result v0

    iget-object v3, p0, Ltqi;->d:Ljava/time/ZoneOffset;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Ltqi;->c:Ljava/time/Instant;
    ...
    iget-object v1, p0, Ltqi;->d:Ljava/time/ZoneOffset;
