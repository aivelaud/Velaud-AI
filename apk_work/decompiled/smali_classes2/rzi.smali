...
.method public static J(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lrzi;->M(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lrzi;->M(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
# virtual methods
.method public final K([Ll58;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 9
    ...
    iget-object v5, v4, Ll58;->a:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v4}, Lrzi;->L(Ll58;)Landroid/graphics/fonts/Font;
    ...
    iget-object v6, v4, Ll58;->e:Ljava/lang/String;
...
.method public L(Ll58;)Landroid/graphics/fonts/Font;
    .locals 0
...
.method public final r(Landroid/content/Context;Ls48;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    iget-object v2, v2, Lt48;->d:Ljava/lang/String;
    ...
    invoke-static {p1, p4}, Lrzi;->J(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final s(Landroid/content/Context;[Ll58;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-virtual {p0, p2, p1}, Lrzi;->K([Ll58;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-static {p0, p3}, Lrzi;->J(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final t(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p0, v0, p1}, Lrzi;->K([Ll58;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, v4, p1}, Lrzi;->K([Ll58;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Lrzi;->J(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
