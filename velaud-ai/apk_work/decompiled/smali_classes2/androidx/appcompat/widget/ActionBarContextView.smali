...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p0, v0, Lt;->c:Ljava/lang/Object;

    const/4 v1, 0x0

    iput-boolean v1, v0, Lt;->b:Z

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->E:Lt;
...
.method public final c(Lrb;)V
    ...
    invoke-direct {v2, v1, p1}, Ls9;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lrb;->d()Lpub;

    move-result-object p1

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->H:Lnb;
    ...
    invoke-direct {v0, v2}, Lnb;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->H:Lnb;

    const/4 v2, 0x1

    iput-boolean v2, v0, Lnb;->P:Z

    iput-boolean v2, v0, Lnb;->Q:Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->H:Lnb;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->F:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Lpub;->b(Lqvb;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->H:Lnb;

    iget-object v2, p1, Lnb;->L:Lsvb;

    if-nez v2, :cond_3

    iget-object v3, p1, Lnb;->H:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lnb;->L:Lsvb;

    iget-object v3, p1, Lnb;->G:Lpub;

    invoke-interface {v1, v3}, Lsvb;->b(Lpub;)V

    invoke-virtual {p1}, Lnb;->i()V

    :cond_3
    iget-object v1, p1, Lnb;->L:Lsvb;
    ...
    invoke-virtual {v2, p1}, Landroidx/appcompat/widget/ActionMenuView;->setPresenter(Lnb;)V
...
.method public final e()V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarContextView;->P:Landroid/view/View;
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->J:Lymj;

    if-eqz v0, :cond_0

    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarContextView;->E:Lt;
...
.method public final i(IJ)Lymj;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->E:Lt;
    ...
    :cond_1
    invoke-static {p0}, Lgkj;->a(Landroid/view/View;)Lymj;

    move-result-object p0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {p0, v1}, Lymj;->a(F)V

    invoke-virtual {p0, p2, p3}, Lymj;->c(J)V

    iget-object p2, v0, Lt;->c:Ljava/lang/Object;

    check-cast p2, Landroidx/appcompat/widget/ActionBarContextView;

    iput-object p0, p2, Landroidx/appcompat/widget/ActionBarContextView;->J:Lymj;

    iput p1, v0, Lt;->a:I

    invoke-virtual {p0, v0}, Lymj;->d(Lanj;)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lnb;->F:Landroid/content/Context;
...
.method public final onLayout(ZIIII)V
    ...
    :goto_7
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarContextView;->G:Landroidx/appcompat/widget/ActionMenuView;
