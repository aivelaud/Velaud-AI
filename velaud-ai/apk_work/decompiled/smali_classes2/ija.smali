...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iget-object p0, v9, Lq8b;->G:Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Lija;->setOrientation(I)V
    ...
    invoke-virtual {v0, p1}, Lija;->setGravity(I)V
    ...
    invoke-virtual {v0, p1}, Lija;->setBaselineAligned(Z)V
    ...
    iput-boolean p1, v0, Lija;->L:Z

    const/4 p1, 0x5

    invoke-virtual {v9, p1}, Lq8b;->r(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    invoke-virtual {v0, p1}, Lija;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public final c(Landroid/graphics/Canvas;I)V
    ...
    iget-object v0, p0, Lija;->O:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lija;->O:Landroid/graphics/drawable/Drawable;
...
.method public f(Landroid/util/AttributeSet;)Lhja;
    .locals 1
...
.method public g(Landroid/view/ViewGroup$LayoutParams;)Lhja;
    .locals 0
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Lija;->f(Landroid/util/AttributeSet;)Lhja;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 5
    invoke-virtual {p0, p1}, Lija;->g(Landroid/view/ViewGroup$LayoutParams;)Lhja;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lija;->getVirtualChildCount()I
    ...
    invoke-virtual {p0, v2}, Lija;->h(I)Z
    ...
    invoke-virtual {p0, p1, v4}, Lija;->c(Landroid/graphics/Canvas;I)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lija;->h(I)Z
    ...
    :goto_1
    invoke-virtual {p0, p1, v0}, Lija;->c(Landroid/graphics/Canvas;I)V
    ...
    :goto_3
    invoke-virtual {p0, p1, v5}, Lija;->d(Landroid/graphics/Canvas;I)V
    ...
    :goto_5
    invoke-virtual {p0, p1, v0}, Lija;->d(Landroid/graphics/Canvas;I)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual {v0}, Lija;->getVirtualChildCount()I

    move-result v12

    iget v13, v0, Lija;->I:I
    ...
    :goto_3
    invoke-virtual {v0, v4}, Lija;->h(I)Z
    ...
    iget v12, v0, Lija;->I:I

    and-int/2addr v7, v12

    and-int/lit8 v12, v12, 0x70

    iget-boolean v13, v0, Lija;->E:Z

    iget-object v14, v0, Lija;->M:[I

    iget-object v15, v0, Lija;->N:[I
    ...
    :cond_14
    :goto_c
    invoke-virtual {v0, v5}, Lija;->h(I)Z
...
.method public onMeasure(II)V
    ...
    iget v12, v0, Lija;->J:I

    iget v11, v0, Lija;->Q:I

    add-int/2addr v12, v11

    iput v12, v0, Lija;->J:I
    ...
    invoke-virtual {v0, v15}, Lija;->h(I)Z
    ...
    iget-object v1, v0, Lija;->M:[I

    const/4 v9, 0x4

    if-eqz v1, :cond_2a

    iget-object v1, v0, Lija;->N:[I
    ...
    iput-object v1, v0, Lija;->M:[I

    new-array v1, v9, [I

    iput-object v1, v0, Lija;->N:[I

    :cond_2b
    iget-object v10, v0, Lija;->M:[I

    iget-object v11, v0, Lija;->N:[I
    ...
    iget-boolean v14, v0, Lija;->E:Z

    iget-boolean v15, v0, Lija;->L:Z
    ...
    :cond_2e
    invoke-virtual {v0, v1}, Lija;->h(I)Z
    ...
    invoke-virtual {v0, v6}, Lija;->h(I)Z
...
.method public setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Lija;->O:Landroid/graphics/drawable/Drawable;
